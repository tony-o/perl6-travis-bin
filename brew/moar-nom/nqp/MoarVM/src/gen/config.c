...
MVMObject *MVM_backend_config(MVMThreadContext *tc) {
    ...
    MVMROOT(tc, config, {
        ...
        add_entry(tc, config, "ccmiscflags", "-Wdeclaration-after-statement -Werror=declaration-after-statement");
        ...
        add_entry(tc, config, "cflags", "-Wdeclaration-after-statement -Werror=declaration-after-statement -O3 -DNDEBUG  -D_REENTRANT -D_FILE_OFFSET_BITS=64 -fPIC");
        ...
        add_entry(tc, config, "has_pthread_yield", "1");
...
");
        ...
        add_entry(tc, config, "ldflags", " -O3 -DNDEBUG -Wl,-rpath,/home/travis/brew/moar-nom/install/lib -Wl,-rpath,/home/travis/brew/moar-nom/install/share/perl6/site/lib");
        ...
        add_entry(tc, config, "ldrpath", "-Wl,-rpath,/home/travis/brew/moar-nom/install/lib -Wl,-rpath,/home/travis/brew/moar-nom/install/share/perl6/site/lib");
...
");
        ...
        add_entry(tc, config, "version", "2016.03");
        add_entry(tc, config, "versionmajor", "2016");
